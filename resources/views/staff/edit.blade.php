...
<div class="card border-0 rounded shadow p-4 mt-4" style="margin-top: 60px !important">
    <h5 class="mb-0">Edit Staff : {{$staff->first_name}} </h5>
        ...
        <div class="row mt-4">
            <div class="col-lg-6">
                <div class="mb-3">
                    ...
                    <div class="form-icon position-relative">
                        ...
                        <input name="firstname" id="firstname" value="{{$staff->first_name}}" type="text" class="form-control ps-5" placeholder="Firsname :">
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="mb-3">
                    ...
                    <div class="form-icon position-relative">
                        <i data-feather="user" class="fea icon-sm icons"></i>
                        <input name="lastname" id="lastname" type="text" class="form-control ps-5" value="{{$staff->last_name}}" placeholder="Firsname :">
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="mb-3">
                    ...
                    <div class="form-icon position-relative">
                        ...
                        <input name="phone" id="phone" value="{{$staff->profile->phone}}" type="number" class="form-control ps-5" placeholder="Phone :">
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="mb-3">
                    ...
                    <div class="form-icon position-relative">
                        ...
                        <input name="email" id="email" type="email" value="{{$staff->email}}" class="form-control ps-5" placeholder="Email :">
                    </div>
                </div>
            </div>
            <!--end col-->
