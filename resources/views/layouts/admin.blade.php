...
<body>
    <div id="app">
        ...
        <div class="page-wrapper landrick-theme toggled">
            <nav id="sidebar" class="sidebar-wrapper sidebar-{{auth()->user()->type == 'super' ? 'dark' : 'colored'}}">
                <div class="sidebar-content" data-simplebar style="height: calc(100% - 60px);">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="sidebar-dropdown">
                            <a href="javascript:void(0)"><i class="ti ti-apps me-2"></i>Staff</a>
                            <div class="sidebar-submenu">
                                <ul>
                                    <li><a href="/admin/staffs">All</a></li>
                                    @if (auth()->user()->type == 'super')
                                    <li><a href="/admin/staff/add">Add</a></li>
                                    @endif
                                </ul>
                            </div>
                        </li>
                        <li class="sidebar-dropdown">
                            <a href="javascript:void(0)"><i class="ti ti-user me-2"></i>Clients</a>
                            <div class="sidebar-submenu">
                                <ul>
                                    <li><a href="/admin/clients">All</a></li>
                                    <li><a href="/admin/client/add">Add New</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="sidebar-dropdown">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    <li><a href="/admin/projects">All</a></li>
                                    <li><a href="/admin/project/add">Add New</a></li>
                                </ul>
                            </div>
                        </li>

                        <li class="sidebar-dropdown">
                            <a href="javascript:void(0)"><i class="ti ti-diamond me-2"></i>Testimonials</a>
                            <div class="sidebar-submenu">
                                <ul>
                                    <li><a href="/admin/testimonials">All</a></li>
                                    <li><a href="/admin/testimonials/add">Add New</a></li>
                                </ul>
                            </div>
                        </li>
                            ...
                            <li class="list-inline-item mb-0 ms-1">
                                <div class="dropdown dropdown-primary">
                                    ...
                                    <div class="dropdown-menu dd-menu dropdown-menu-end bg-white shadow border-0 mt-3 py-3" style="min-width: 200px;">
                                        ...
                                        <a class="dropdown-item text-dark" href="/admin"><span class="mb-0 d-inline-block me-1"><i class="ti ti-home"></i></span> Dashboard</a>
                                        <a class="dropdown-item text-dark" href="/admin/profile"><span class="mb-0 d-inline-block me-1"><i class="ti ti-home"></i></span> Profile</a>
